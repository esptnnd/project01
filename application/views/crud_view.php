...
<body>
  ...
  <div class="container">
	...
	<!-- Modal Add Produk-->
	  <form id="add-row-form" action="<?php echo base_url().'index.php/page/simpan'?>" method="post">
	 ...
	 <!-- Modal Hapus Produk-->
 	  <form id="add-row-form" action="<?php echo base_url().'index.php/page/delete'?>" method="post">
